...
APPLY_ALL_SHAPEKEYS_GROUP_NAME = "ApplyAllShapekeysWhenExport"  # エクスポート時にシェイプキーを適用するオブジェクトのグループ名
...
def register():
    ...
    bpy.types.WindowManager.mizore_exporter_apply_all_shapekeys_group_name = APPLY_ALL_SHAPEKEYS_GROUP_NAME
...
def unregister():
    ...
    del bpy.types.WindowManager.mizore_exporter_apply_all_shapekeys_group_name
